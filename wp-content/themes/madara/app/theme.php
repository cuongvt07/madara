<?php
	...
	class MadaraStarter extends Madara {
		...
		public function release_logs() {
			?>
            <ul>
				<li>Version 2.2.7.2 - 2026.01.10<br/>
					<ul>
						<li>#Add: Side By Side view for (Images) Chapter Reading Page (Customizer > Manga Reading Page)</li>
						<li>#Fix: Amazon S3 storage issue</li>
						<li>#Fix: minor issues</li>
					</ul>
				</li>
				<li>Version 2.2.7.1 - 2025.12.21<br />
					<ul>
						<li>#Add: option to change Sidebar size in Customize &gt; General Layout</li>
					</ul>
				</li>
