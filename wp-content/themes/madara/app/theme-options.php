			...
			'settings' => array(
				...
				* */
				...
				array(
					...
					'desc'      => esc_html__( 'Custom Title Meta for Single Manga Reading page. Use tag %title% for current Manga Title, %chapter% for current Manga Chapter, %chapter_index% for current Chapter Index, %vol% for volumn name. When using with Yoast SEO, this will override the meta title in Yoast', 'madara' ),
					'std'       => '',
					'type'      => 'text',
					'section'   => 'manga_single',
				),
				...
				array(
					'id'        => 'manga_reading_side2side',
					'label'     => esc_html__( 'Side by Side', 'madara' ),
					'desc'      => '',
					'std'       => 'no',
					'type'      => 'select',
					'section'   => 'manga_reading',
					'choices'   => array(
						array(
							'value' => 'yes',
							'label' => esc_html__( '2 images side by side', 'madara' ),
						),
						array(
							'value' => 'no',
							'label' => esc_html__( 'Custom images per page', 'madara' ),
						)
					),
				...
				array(
					...
					'choices'   => array(
						...
						array(
							'value' => '2',
							'label' => esc_html__( '2 images', 'madara' ),
						),
						array(
							'value' => '3',
						...
						array(
							'value' => '4',
							'label' => esc_html__( '4 images', 'madara' ),
						),
						array(
							'value' => '5',
							'label' => esc_html__( '5 images', 'madara' ),
						),
						array(
							'value' => '6',
						...
						array(
							'value' => '7',
							'label' => esc_html__( '7 images', 'madara' ),
						),
						array(
							'value' => '8',
							'label' => esc_html__( '8 images', 'madara' ),
						),
						array(
							'value' => '9',
							'label' => esc_html__( '9 images', 'madara' ),
						),
						array(
							'value' => '10',
					...
					'condition' => 'manga_reading_side2side:is(no)',
				),
