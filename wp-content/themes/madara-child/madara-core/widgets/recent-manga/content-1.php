...
<?php if (has_post_thumbnail()) { ?>
    <div class="popular-img widget-thumbnail c-image-hover">
        <a title="<?php echo esc_attr(get_the_title()); ?>" href="<?php echo esc_url(get_the_permalink()); ?>">
            <?php
            // Changed from 'manga_wg_post_1' to 'medium' to ensure high resolution
...
<div class="popular-content">
    ...
    <div class="list-chapter">
        <?php
        global $wpmanga_recent_manga_ids;

        $wp_manga_functions->manga_meta_cached($wpmanga_recent_manga_ids, get_the_ID()); ?>
    </div>
